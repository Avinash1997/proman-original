...
INSERT INTO proman.ROLES (ID, UUID, NAME, DESCRIPTION, STATUS, CREATED_BY)
		...
		(3, 103, 'Team Leader', 'Team Leader', true, CURRENT_USER),
		(4, 104, 'Developer', 'Developer', true, CURRENT_USER);
...
INSERT INTO proman.ROLE_PERMISSIONS (ROLE_ID, PERMISSION_ID, CREATED_BY)
		...
		(1,22, CURRENT_USER),
		(2,4, CURRENT_USER), (2,5, CURRENT_USER), (2,6, CURRENT_USER), (2,7, CURRENT_USER),
        (2,8, CURRENT_USER), (2,9, CURRENT_USER), (2,10, CURRENT_USER), (2,11, CURRENT_USER), (2,12, CURRENT_USER), (2,13, CURRENT_USER), (2,14, CURRENT_USER),
        (2,15, CURRENT_USER), (2,16, CURRENT_USER), (2,17, CURRENT_USER), (2,18, CURRENT_USER), (2,19, CURRENT_USER), (2,20, CURRENT_USER), (2,21, CURRENT_USER),
        (2,22, CURRENT_USER),
        (3,12, CURRENT_USER), (3,13, CURRENT_USER), (3,14, CURRENT_USER), (3,15, CURRENT_USER), (3,16, CURRENT_USER), (3,17, CURRENT_USER), (3,18, CURRENT_USER),
        (4,16, CURRENT_USER), (4,17, CURRENT_USER), (4,18, CURRENT_USER);
...
INSERT INTO proman.USERS (ID, ROLE_ID, UUID, EMAIL, PASSWORD, SALT, FIRST_NAME, LAST_NAME,
		...
		VALUES 
		(1, 1, '7d174a25-ba31-45a8-85b4-b06ffc9d5f8f', 'admin@proman.io', '513B71CA1E636A14', 'GTHUJ61gKaoTipNHM00E0o7gy3KSbjGkN10oxsFUUKA=', 'Proman', 'Administrator',
